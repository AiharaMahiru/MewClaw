"use strict";
(() => {
  // packages/lark/mewclaw-brand/lib/mark.js
  ...
  function renderMewClawBrandMark(React, props) {
    ...
    return React.createElement("svg", {
      ...
      "aria-hidden": "true",
      focusable: "false"
    }, React.createElement("circle", { className: "mewclaw-mark-bg", cx: "256", cy: "256", r: "256" }), React.createElement("path", {
    ...
    }), React.createElement("path", { className: "mewclaw-mark-cutout", fill: "none", strokeWidth: "62", strokeLinecap: "round", d: "M116.9 410.6 A208 208 0 0 0 234.2 462.8" }), React.createElement("path", { className: "mewclaw-mark-ink", fill: "none", strokeWidth: "34", strokeLinecap: "round", d: "M116.9 410.6 A208 208 0 0 0 234.2 462.8" }), React.createElement("path", { className: "mewclaw-mark-cutout", fill: "none", strokeWidth: "62", strokeLinecap: "round", d: "M366.2 432.4 A208 208 0 0 0 462.9 234.3" }), React.createElement("path", { className: "mewclaw-mark-ink", fill: "none", strokeWidth: "34", strokeLinecap: "round", d: "M366.2 432.4 A208 208 0 0 0 462.9 234.3" }), React.createElement("g", { className: "mewclaw-mark-ink", fill: "none", strokeWidth: "10", strokeLinecap: "round" }, React.createElement("path", { d: "M128 276 L44 252" }), React.createElement("path", { d: "M126 300 L50 296" })), React.createElement("g", { className: "mewclaw-mark-cutout", fill: "none", strokeWidth: "15", strokeLinecap: "round" }, React.createElement("path", { d: "M174 266 Q204 300 234 266" }), React.createElement("path", { d: "M278 266 Q308 300 338 266" })), React.createElement("path", { className: "mewclaw-mark-cutout", d: "M247 312 L265 312 L256 325 Z", strokeWidth: "7", strokeLinejoin: "round" }));
  }

  // packages/lark/mewclaw-brand/lib/client-impl.js
  ...
  function applyBrand(ctx, React) {
    ctx.slots.inject("conversation.hero.brand.mark", () => ctx.slots.register({ name: "conversation.hero.brand.mark" }, () => {
      ...
      return React.createElement("span", { className: "mewclaw-hero-brand" }, renderMewClawBrandMark(React, { size: 46, className: "mewclaw-hero-mark" }), React.createElement("span", { className: "mewclaw-hero-copy" }, copy));
    }));
  ...
  // packages/lark/mewclaw-brand-desktop/src/client.ts
